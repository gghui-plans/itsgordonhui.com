---
title: "Would we build it without the grant?"
subtitle: "A practical guide to municipal transportation grant decisions, from 12 Ontario projects"
slug: "would-we-build-it-without-the-grant"
description: "What would a municipality most plausibly do if the grant never arrived, and what should that answer change about how it decides to pursue and accept transportation funding?"
publicationType: "Flagship paper"
publishedDate: 2026-09-07
abstract: >-
  A funding program asks whether a project is eligible and competitive. A
  municipality has a different decision to make: whether pursuing and accepting
  the funding advances its own priorities on acceptable terms. This paper
  reviews 12 Ontario municipal transportation projects and the grant decisions
  attached to them, using only public municipal documents. Those documents were
  consistently clear about why a project was wanted, whether it was ready to
  build and where the capital was coming from. They were much less clear about
  what the municipality would have done without the grant, what else the money
  and staff time could have gone to, what the project would cost to own over its
  life, and what it delivered once built. That finding describes what
  municipalities published. It does not describe what they thought. Drawing on
  the gaps the 12 cases revealed, the paper then proposes a municipal grant
  decision system built on three separate decisions, Investigate, Apply and
  Accept, together with a Municipal Grant Decision Summary and an optional
  acceptance worksheet. The
  system is professional guidance developed after the analysis. It was not
  applied to the 12 cases and has not been tested in practice.
keyFindings:
  - "All 12 projects addressed either an Established Priority or an Identified Future Need. Seven were already approved and programmed before the funding opportunity appeared; five sat in an approved plan without funding."
  - "Municipal reports consistently showed where the money came from, and much less often showed what difference the money made."
  - "In 11 of the 12 projects the public record could not answer whether the work would have gone ahead without the grant, so the effect was recorded as Indeterminate. That describes what was published, not what staff considered internally."
  - "Only Oshawa stated in an approved capital project sheet that construction would not proceed if the application failed. It is the sole case where the record supports calling the funding Additional."
  - "Projects commonly changed after the award, but the changes concerned getting the work built. They were not directed at reconsidering whether the approved project was still the right one."
  - "No case was Potentially Distortionary or Distortionary, and nothing in the 12 cases suggests grants pulled municipalities away from their own priorities."
  - "The counts describe a purposive 12-case sample selected for unusually complete records. They are not province-wide estimates."
topics:
  ...
  - ontario
sourceVersion: "Would We Build It Without the Grant? A Practical Guide to Municipal Transportation Grant Decisions, final, September 7, 2026. The finalized paper carries no version number."
companionVersion: "Would We Build It Without the Grant? Technical Companion: What 12 Ontario Municipal Cases Show and the Evidence Behind the Findings, final, September 7, 2026. The finalized companion carries no version number."
---
...
[^3]: Technical companion, Box 2 and Schedules A3, C1, D2 and D5. Underlying public sources include City of Oshawa, *Active Transportation Fund Update (FIN-22-23)* (February 23, 2022) and *2023 Approved Capital Projects* (January 19, 2023). Verified links and locations are in technical-companion source note 7.

[^4]: Technical companion, Box 4 and Schedules A8, C1, D7 and D8. Underlying public sources include County of Dufferin, *Dufferin Climate Action Plan* (March 11, 2021), *Electric Vehicle Charging Station Policy 5-6-09* (September 9, 2021) and *Charge Up in Dufferin* (registered metrics updated December 31, 2025; publication date not established). Verified links and locations are in technical-companion source note 12.

---

<!-- BEGIN DETACHABLE PAGE 1 -->
...
<!-- END DETACHABLE PAGE 1 -->

---

<!-- BEGIN DETACHABLE PAGE 2 -->
